...
| Setup Consensus node           | [Link](https://github.com/itrocket-team/testnet_guides/blob/main/celestia/consensus.md) |
|---------------------------|-------------------------------------|
| Setup Bridge node         | [Link](https://github.com/itrocket-team/testnet_guides/blob/main/celestia/testnet/bridge.md) |
| Setup Light node          | [Link](https://github.com/itrocket-team/testnet_guides/blob/main/celestia/testnet/light.md) |  
| Setup Full Storage node          | [Link](https://github.com/itrocket-team/testnet_guides/blob/main/celestia/testnet/full_storage.md) | 
| Setup Monitoring          | [Link](https://github.com/itrocket-team/testnet_guides/blob/main/celestia/testnet/tenderduty.md) |  
...
If you want to have set up a monitoring and alert system use [our Celestia nodes monitoring guide with tenderduty](https://github.com/itrocket-team/testnet_guides/blob/main/celestia/testnet/tenderduty.md)  
Stay tuned!
